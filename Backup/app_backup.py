...
st.set_page_config(page_title="FIDC-CDA MVP", layout="wide", page_icon=_favicon())
...
# ===========================================================================
    ...
    with st.form("form_upload"):
        ...
        c1, c2 = st.columns(2)
        gestora_in = c1.text_input("Gestora (concorrente)",
                                   placeholder="Ex.: M8 Capital")
        fundo_cnpj_in = c2.text_input("CNPJ do fundo",
                                      placeholder="00.000.000/0001-00")
        comp_in = st.text_input("Competência (AAAA-MM)", placeholder="2026-05")
